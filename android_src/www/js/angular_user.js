...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/user_login.php', 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/admin_login.php', 
			{'email': $scope.email, 'password':$scope.password})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
...
//************************** admin_register **********************************/	
	...
	{		
		$http.post('http://10.0.2.2/projects/buspass/web/admin_register.php',{
...
/************************** Update User Info **********************************/
		...
		$http.post('http://10.0.2.2/projects/buspass/web/get_user_info.php',
		{
	...
	{		
		$http.post('http://10.0.2.2/projects/buspass/web/admin_update.php',{
		 'name':$scope.name,'email':$scope.email,
		 'password':$scope.password,'mobile': $scope.mobile})
		.success(function(data, status, headers, config) 
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/newpassword.php', 
			{	'email': $scope.email, 'password':$scope.password,
