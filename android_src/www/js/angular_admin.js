...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/buspass/web/update_status.php',{
		 'email':email
		 })
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/buspass/web/create_employee.php', 
		{
	...
	$http.post('http://10.0.2.2/projects/buspass/web/user_register.php', 
		{
		'name':$scope.name1,'email':$scope.email,'password':$scope.password,
	...
	{
	$http.post('http://10.0.2.2/projects/buspass/web/create_bus.php', 
		{
	...
	{
	$http.post('http://10.0.2.2/projects/buspass/web/create_bus_speed.php', 
		{
		'field_1':$scope.field_1,'field_2':$scope.field_2,
		'field_3':$scope.field_3,'field_4':$scope.field_4
		})
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/buspass/web/get_employee_info.php', 
		{
...
$scope.save_employee = function() 
	{
	$http.post('http://10.0.2.2/projects/buspass/web/save_employee.php', {
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/buspass/web/create_category.php', 
		{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/buspass/web/create_dept.php', 
		{
...
$scope.save_dept = function() 
	{
	$http.post('http://10.0.2.2/projects/buspass/web/save_dept.php', {
...
$scope.save_cat = function() 
	{
	$http.post('http://10.0.2.2/projects/buspass/web/save_cat.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/buspass/web/create_site.php', 
		{
		'field_1':$scope.field_1
		})
		.success(function(data, status, headers, config) 
...
$scope.save_site = function() 
	{
	$http.post('http://10.0.2.2/projects/buspass/web/save_site.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/buspass/web/create_area.php', 
		{
		'field_1':$scope.field_1,'field_2':$scope.field_2
		})
		.success(function(data, status, headers, config) 
...
$scope.save_area = function() 
	{
	$http.post('http://10.0.2.2/projects/buspass/web/save_area.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
$scope.get_site_area = function(field_6) 
	{
	$http.post('http://10.0.2.2/projects/buspass/web/get_site_area.php', {
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/buspass/web/create_user.php', 
		{
		'field_1':$scope.field_1
		})
		.success(function(data, status, headers, config) 
...
$scope.save_user = function() 
	{
	$http.post('http://10.0.2.2/projects/buspass/web/save_user.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/delete_hirarchy.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/delete_tat.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/delete_question.php', 
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/delete_dept.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/delete_cat.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/delete_area.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/delete_bus.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/buspass/web/delete_site.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/buspass/web/application_get_admin.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/buspass/web/update_tat_grievance.php')
		.success(function(data, status, headers, config) 
		{
				$scope.update_tat_details = data.details;
		});

	$http.post('http://10.0.2.2/projects/buspass/web/get_tat.php')
	.success(function(data, status, headers, config) 
	{
	...
	$http.post('http://10.0.2.2/projects/buspass/web/get_dept.php', 
		{
	...
	$http.post('http://10.0.2.2/projects/buspass/web/get_hirarchy.php')
	.success(function(data, status, headers, config) 
	{
			$scope.hirarchy_details = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/buspass/web/get_site.php')
	.success(function(data, status, headers, config) 
	{
			$scope.site_details = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/buspass/web/get_area.php')
	.success(function(data, status, headers, config) 
	{
			$scope.area_details = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/buspass/web/get_user_type.php')
	.success(function(data, status, headers, config) 
	{
			$scope.user_type_details = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/buspass/web/get_site_results.php')
	.success(function(data, status, headers, config) 
	{
			$scope.all_site_results = data.details;
	});
	
	$http.post('http://10.0.2.2/projects/buspass/web/get_search_results.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/buspass/web/user_get_all.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/buspass/web/create_tat.php', 
		{
		'field_1':$scope.field_1,'field_2':$scope.field_2,
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/buspass/web/save_hirarchy.php',{
...
/****************************************************************************/	
	...
	{		
		$http.post('http://10.0.2.2/projects/buspass/web/save_tat.php',{
...
/****************************************************************************/
		...
		$http.post('http://10.0.2.2/projects/buspass/web/get_admin_info.php',
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/buspass/web/admin_update_info.php',{
...
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/buspass/web/get_all_results.php')
		.success(function(data, status, headers, config) 
		{
	...
	$http.post('http://10.0.2.2/projects/buspass/web/get_all_speed_bus.php')
		.success(function(data, status, headers, config) 
		{
...
$scope.save_bus = function() 
	{
	$http.post('http://10.0.2.2/projects/buspass/web/save_bus.php', {
			'id': $scope.cus_id,
			'field_1': $scope.cook_field_1,'field_2': $scope.cook_field_2, 
			'field_3': $scope.cook_field_3,  'field_4': $scope.cook_field_4})
	.success(function(data, status, headers, config) 
...
$scope.pay_bus = function(field_1,field_2,field_3,field_4) 
	{
	$http.post('http://10.0.2.2/projects/buspass/web/create_bus_pay.php', {
