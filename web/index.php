...
<form action="qrcode.php" method="post">
	<!-- <input name="data" value="',(isset($_REQUEST['data'])?htmlspecialchars($_REQUEST['data']):'请在此输入内容'),'">';
	-->
	 <input name="data" value=' <?php echo 'Bus Pass ID'.$_COOKIE["cook_field_9"]; ?> ' > 
...
<html ng-app="myapp">
	<head>
		...
		<link rel="stylesheet" href="fonts/f-ont.css">
