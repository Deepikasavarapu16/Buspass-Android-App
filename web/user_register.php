...
$get_field_10_2 = ($data->field_10);
$get_field_10 = substr ($get_field_10_2, 0, 10); 
$get_field_9 = "Pending";
...
else if (strcmp($get_password ,$get_password_2 )!=0)
{
	$response["success"] = 7;
	echo json_encode($response);
}
...
else
{
	...
	// get customer 
	$result1 = mysqli_query($conn,"INSERT INTO login( name, email,password,mobile,
