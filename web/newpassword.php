...
{	
	...
	$result = mysqli_query($conn,"SELECT * FROM login WHERE 
	email = '$get_empid' AND  mobile= '$get_field_3'  AND field_4= '$get_field_4'");

		if (mysqli_num_rows($result))
		{
			mysqli_query($conn,"update login set password = '$get_password' where email = '$get_empid'");
