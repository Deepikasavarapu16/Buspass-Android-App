...
$http.post('https://myapphosting.in/android/buspass/get_site.php')
	...
	$http.post('https://myapphosting.in/android/buspass/get_survey.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/buspass/sum_get.php', {
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/buspass/get_comment.php', {
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/buspass/get_choice.php', {
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/buspass/get_yesno.php', {
			'email': $scope.cook_email,'field_3': $scope.cook_field_3})
		.success(function(data, status, headers, config) 
		{
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/buspass/get_ratecomment.php', {
			'email': $scope.cook_email,'field_3': $scope.cook_field_3})
		.success(function(data, status, headers, config) 
		{
