...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/buspass/get_user_ticket_last.php', 
		{
	...
	$http.post('https://myapphosting.in/android/buspass/get_all_ticket.php', 
		{
		'id':$scope.cook_user_email
		})
		.success(function(data, status, headers, config) 
	...
	$http.post('https://myapphosting.in/android/buspass/get_user_grievance.php', 
		{
	...
	$http.post('https://myapphosting.in/android/buspass/get_user_ticket.php', 
		{
		'id':$scope.cook_user_mail
		})
		.success(function(data, status, headers, config) 
	...
	$http.post('https://myapphosting.in/android/buspass/get_user_redressal.php', 
		{
	...
	$http.post('https://myapphosting.in/android/buspass/get_hostel_redressal.php', 
		{
		'id':$scope.cook_user_type,'dept':$scope.cook_user_dept
		})
		.success(function(data, status, headers, config) 
	...
	$http.post('https://myapphosting.in/android/buspass/get_food_redressal.php', 
		{
		'id':$scope.cook_user_type,'dept':$scope.cook_user_dept
		})
		.success(function(data, status, headers, config) 
	...
	$http.post('https://myapphosting.in/android/buspass/get_all_college_redressal.php', 
		{
	...
	$http.post('https://myapphosting.in/android/buspass/get_all_redressal.php')
		.success(function(data, status, headers, config) 
		{
			$scope.all_redressal_details = data.details;
        });
		
	$http.post('https://myapphosting.in/android/buspass/get_forward.php',{
...
/****************************************************************************/
	...
	$scope.create_application = function() 
	{
		...
		$http.post('https://myapphosting.in/android/buspass/create_application.php', 
		{
...
/****************************************************************************/
	...
	{
		$http.post('https://myapphosting.in/android/buspass/read_notification.php', 
		{
...
$scope.user_update_info = function(name,password,mobile) 
	...
	{		
		$http.post('https://myapphosting.in/android/buspass/user_update_info.php',{
...
/****************************************************************************/
	...
	{		
		$http.post('https://myapphosting.in/android/buspass/save_rating.php',{
...
/****************************************************************************/
	...
	{		
		$http.post('https://myapphosting.in/android/buspass/delay_grievance.php',{
...
/****************************************************************************/
	...
	{		
		$http.post('https://myapphosting.in/android/buspass/forward_grievance.php',{
...
/****************************************************************************/
	...
	{		
        ...
        $http.post('https://myapphosting.in/android/buspass/update_location.php', 
			{	
...
$scope.save_renewal = function() 
	{
	$http.post('https://myapphosting.in/android/buspass/save_renewal.php', 
			{
	...
	{		
		$http.post('https://myapphosting.in/android/buspass/save_student_status.php',{
