...
/****************************************************************************/
	...
	{		
		$http.post('https://myapphosting.in/android/buspass/update_status.php',{
		 'email':email
		 })
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/buspass/create_employee.php', 
		{
	...
	{
				$scope.field_2 = "Student";

	$http.post('https://myapphosting.in/android/buspass/user_register.php', 
		{
		'name':$scope.name1,'email':$scope.email,'password':$scope.password,
		'password2':$scope.password2,
		'mobile':$scope.mobile,'field_1':$scope.field_1,'field_2':$scope.field_2,
		'field_3':$scope.field_3,'field_10':$scope.field_10,'field_4':$scope.field_4,
		'field_5':$scope.field_5,'field_6':$scope.field_6,
		'field_7':$scope.field_7,'field_8':$scope.field_8
		})
		.success(function(data, status, headers, config) 
	...
	$scope.create_bus = function() 
	{
	$http.post('https://myapphosting.in/android/buspass/create_bus.php', 
		{
	...
	$scope.create_bus_speed = function() 
	{
	$http.post('https://myapphosting.in/android/buspass/create_bus_speed.php', 
		{
		'field_1':$scope.field_1,'field_2':$scope.field_2,
		'field_3':$scope.field_3,'field_4':$scope.field_4
		})
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/buspass/get_employee_info.php', 
		{
...
$scope.save_employee = function() 
	{
	$http.post('https://myapphosting.in/android/buspass/save_employee.php', {
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/buspass/create_category.php', 
		{
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/buspass/create_dept.php', 
		{
		'field_1':$scope.field_1,'id': $scope.cook_user_mail
		})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
...
$scope.save_dept = function() 
	{
	$http.post('https://myapphosting.in/android/buspass/save_dept.php', {
...
$scope.save_cat = function() 
	{
	$http.post('https://myapphosting.in/android/buspass/save_cat.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/buspass/create_site.php', 
		{
		'field_1':$scope.field_1
		})
		.success(function(data, status, headers, config) 
...
$scope.save_site = function() 
	{
	$http.post('https://myapphosting.in/android/buspass/save_site.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/buspass/create_area.php', 
		{
		'field_1':$scope.field_1,'field_2':$scope.field_2
		})
		.success(function(data, status, headers, config) 
...
$scope.save_area = function() 
	{
	$http.post('https://myapphosting.in/android/buspass/save_area.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
$scope.get_site_area = function(field_6) 
	{
	$http.post('https://myapphosting.in/android/buspass/get_site_area.php', {
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/buspass/create_user.php', 
		{
		'field_1':$scope.field_1
		})
		.success(function(data, status, headers, config) 
...
$scope.save_user = function() 
	{
	$http.post('https://myapphosting.in/android/buspass/save_user.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{		
        $http.post('https://myapphosting.in/android/buspass/delete_hirarchy.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('https://myapphosting.in/android/buspass/delete_tat.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('https://myapphosting.in/android/buspass/delete_question.php', 
		{
...
/****************************************************************************/
	...
	{		
        $http.post('https://myapphosting.in/android/buspass/delete_dept.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
	...
	{		
        $http.post('https://myapphosting.in/android/buspass/delete_cat.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('https://myapphosting.in/android/buspass/delete_area.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	// products_delete
	$scope.delete_bus = function(cusid) 
	{		
        $http.post('https://myapphosting.in/android/buspass/delete_bus.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('https://myapphosting.in/android/buspass/delete_site.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/buspass/application_get_admin.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	$http.post('https://myapphosting.in/android/buspass/update_tat_grievance.php')
		.success(function(data, status, headers, config) 
		{
				$scope.update_tat_details = data.details;
		});

	$http.post('https://myapphosting.in/android/buspass/get_tat.php')
	.success(function(data, status, headers, config) 
	{
		$scope.tat_details = data.details;
    });
	
	$http.post('https://myapphosting.in/android/buspass/get_employee.php')
	.success(function(data, status, headers, config) 
	{
		$scope.emp_details = data.details;
    });
	
	$http.post('https://myapphosting.in/android/buspass/get_date.php')
	.success(function(data, status, headers, config) 
	{
	...
	$http.post('https://myapphosting.in/android/buspass/get_dept.php', 
		{
	...
	$http.post('https://myapphosting.in/android/buspass/get_category.php')
	.success(function(data, status, headers, config) 
	{
			$scope.category_details = data.details;
	});
	
	$http.post('https://myapphosting.in/android/buspass/get_hirarchy.php')
	.success(function(data, status, headers, config) 
	{
			$scope.hirarchy_details = data.details;
	});
	
	$http.post('https://myapphosting.in/android/buspass/get_site.php')
	.success(function(data, status, headers, config) 
	{
			$scope.site_details = data.details;
	});
	
	$http.post('https://myapphosting.in/android/buspass/get_area.php')
	.success(function(data, status, headers, config) 
	{
			$scope.area_details = data.details;
	});
	
	$http.post('https://myapphosting.in/android/buspass/get_user_type.php')
	.success(function(data, status, headers, config) 
	{
			$scope.user_type_details = data.details;
	});
	
	$http.post('https://myapphosting.in/android/buspass/get_site_results.php')
	.success(function(data, status, headers, config) 
	{
			$scope.all_site_results = data.details;
	});
	
	$http.post('https://myapphosting.in/android/buspass/get_search_results.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/buspass/user_get_all.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/buspass/create_tat.php', 
		{
		'field_1':$scope.field_1,'field_2':$scope.field_2,
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/buspass/create_hirarchy.php', 
		{
		'field_1':$scope.field_1,'field_2':$scope.field_2,
	...
	{		
		$http.post('https://myapphosting.in/android/buspass/save_hirarchy.php',{
...
/****************************************************************************/	
	...
	{		
		$http.post('https://myapphosting.in/android/buspass/save_tat.php',{
...
/****************************************************************************/
		...
		$http.post('https://myapphosting.in/android/buspass/get_admin_info.php',
		{
			'field_1':$scope.cook_user_mail
		})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
...
/****************************************************************************/
	...
	{		
		$http.post('https://myapphosting.in/android/buspass/admin_update_info.php',{
		  'password':$scope.cook_password,'field_1': $scope.cook_user_mail})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{
...
/****************************************************************************/
	$http.post('https://myapphosting.in/android/buspass/get_all_results.php')
		.success(function(data, status, headers, config) 
		{
			$scope.all_results = data.details;
        });
		
	$http.post('https://myapphosting.in/android/buspass/get_all_bus.php')
		.success(function(data, status, headers, config) 
		{
	...
	$http.post('https://myapphosting.in/android/buspass/get_all_speed_bus.php')
		.success(function(data, status, headers, config) 
		{
			$scope.all_speed_details = data.details;
        });
...
/****************************************************************************/
	...
	$scope.update_grievance = function(email,field_21,field_5,field_13) 
	{
		$cookieStore.put("cook_email",email);
		$cookieStore.put("cook_field_21",field_21);
		$cookieStore.put("cook_field_5",field_5);
		$cookieStore.put("cook_field_13",field_13);
		window.location = "edit_bus_approve.html";
		return;
	}

	$scope.cook_email = $cookieStore.get("cook_email");
	$scope.cook_field_21 = $cookieStore.get("cook_field_21");
	$scope.cook_field_5 = $cookieStore.get("cook_field_5");
	$scope.cook_field_13 = $cookieStore.get("cook_field_13");
	
	
	$scope.save_grievance = function() 
	{		
	
		$scope.cook_field_13 = document.getElementById('cook_field_13').value;
		$scope.cook_field_15 = document.getElementById('cook_field_15').value;
		
		$http.post('https://myapphosting.in/android/buspass/update_grievance.php',{
		 'email':$scope.cook_email, 'field_1':$scope.cook_field_21, 'field_5':$scope.cook_field_5, 
		 'field_13':$scope.cook_field_13, 'field_15':$scope.cook_field_15,
		 'field_16':$scope.cook_field_16
		 })
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
	...
	$scope.print_card = function(field_9) 
	{
	...
	$scope.update_bus = function(cus_id,field_1,field_2,
					field_3,field_4) 
	{
...
$scope.save_bus = function() 
	{
	$http.post('https://myapphosting.in/android/buspass/save_bus.php', {
			'id': $scope.cus_id,
			'field_1': $scope.cook_field_1,'field_2': $scope.cook_field_2, 
			'field_3': $scope.cook_field_3,  'field_4': $scope.cook_field_4})
	.success(function(data, status, headers, config) 
...
$scope.pay_bus = function(field_1,field_2,field_3,field_4) 
	{
	$http.post('https://myapphosting.in/android/buspass/create_bus_pay.php', {
			
			'field_1': field_1,'field_2': field_2, 
			'field_3': field_3, 'field_4': field_4, 
			'email': $scope.cook_user_mail		})
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
			alert("Ticket Booked Successfully");
			window.location = "view_bus_pay.html";
			return;
		}
		else if(data.success == 2)
				{
...
$scope.update_id = function(cus_id) 
	...
	$scope.view_more = function(cus_id) 
	{
		window.location = "view_print.html";
		$cookieStore.put("cook_cus_id",cus_id);
		return;
	}
		$scope.cook_cus_id = $cookieStore.get("cook_cus_id");
